// NoLimits∞nline — How it works
// 4 steps, device check, troubleshooting
  ...
  <section style={{ background: "#FAF6EE", padding: "80px 56px",
    ...
    <div style={{ position: "relative", maxWidth: 1280, margin: "0 auto",
      ...
      <h1 style={{
        ...
        Land. Scan.<br/>
        <span style={{ color: "#2E5BFF" }}>Scroll.</span>
      </h1>
      <p style={{ fontSize: 22, lineHeight: 1.5, margin: 0, maxWidth: 760 }}>
        An eSIM is just a QR code. We email it, you scan it once,
        and your phone has a second data line ready to go.
        Your home SIM stays put — no swapping, no Sim ejector tool, no airport queue.
      </p>
    </div>
  </section>
);
    ...
    <div style={{ maxWidth: 1280, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 40, flexWrap: "wrap", marginBottom: 56 }}>
        <div>
          ...
          <h2 style={{
            ...
            From "where am I going" to <span style={{ fontStyle: "italic", fontWeight: 500, color: "#2E5BFF" }}>"I'm online."</span>
          </h2>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24 }}>
        {[
          ...
          { n: "03", t: "Scan it once", d: "Settings → Mobile data → Add eSIM → camera at the QR. Phone confirms, installs the profile, asks if you want it as your data line. Yes." },
          { n: "04", t: "Land. Connect.", d: "On your flight you can toggle the line on before take-off. It registers automatically when you land. No carrier search dance, no waiting." },
        ].map((s, i) => (
          <div key={s.n} style={{
            ...
            <div>
              <div style={{ fontFamily: "var(--nlo-font-display)", fontWeight: 800,
                fontSize: 28, letterSpacing: "-0.02em", lineHeight: 1.05 }}>{s.t}</div>
...
// ============================================================
const DeviceCheck = () => {
  const [model, setModel] = useStateHIW("");
  const [result, setResult] = useStateHIW(null);
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto",
        ...
        <div>
          ...
          <h2 style={{
            ...
            Will your phone <span style={{ fontStyle: "italic", fontWeight: 500, color: "#2E5BFF" }}>even do this?</span>
          </h2>
          <p style={{ fontSize: 19, lineHeight: 1.6, margin: 0, maxWidth: 580 }}>
            Almost certainly yes, if it's from 2018 or later. iPhones from XS onward,
            Pixels from 4 onward, Samsung Galaxy S20+ and most newer Androids ship
            with eSIM support. Type your model below if you want a quick yes/no.
          </p>

          <div style={{
            marginTop: 28, background: "#fff",
            border: "3px solid #0E0E14", borderRadius: 24,
            boxShadow: "6px 6px 0 #0E0E14", padding: 8,
            display: "flex", alignItems: "center", gap: 6, maxWidth: 520,
          }}>
            <input value={model} onChange={(e) => setModel(e.target.value)}
              onKeyDown={(e) => e.key === "Enter" && check()}
              placeholder="e.g. iPhone 15, Pixel 8…"
              style={{ flex: 1, border: "none", outline: "none", padding: "12px 14px",
                fontFamily: "var(--nlo-font-display)", fontWeight: 600, fontSize: 18,
                letterSpacing: "-0.01em", background: "transparent", minWidth: 0 }} />
          ...
          {result && (
            <div style={{
              ...
              background: result.ok === true ? "#7BE0B5" : result.ok === false ? "#FFD23F" : "#F2EBDC",
              border: "2px solid #0E0E14", borderRadius: 14,
              boxShadow: "3px 3px 0 #0E0E14", maxWidth: 520,
              fontFamily: "var(--nlo-font-display)", fontWeight: 700, fontSize: 16,
        ...
        <div style={{
          ...
          <Mono color="#FFD23F">// SUPPORTED · A SHORT LIST</Mono>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18, marginTop: 18 }}>
            {[
              ...
              <div key={i}>
                <div style={{ fontFamily: "var(--nlo-font-display)", fontWeight: 800,
                  fontSize: 24, letterSpacing: "-0.02em", color: "#FAF6EE" }}>{g.brand}</div>
                <div style={{ fontSize: 14, lineHeight: 1.5, opacity: 0.85, marginTop: 4 }}>
                  {g.models}
                </div>
              </div>
            ))}
          </div>
          <div style={{ borderTop: "1px dashed rgba(250,246,238,0.25)", paddingTop: 16, marginTop: 20,
            fontSize: 14, lineHeight: 1.55, opacity: 0.85 }}>
            <strong style={{ color: "#FF6B6B" }}>Important:</strong> some phones bought in mainland China
            ship without eSIM hardware. If you bought your phone abroad, double-check the model
...
// ============================================================
const Timeline = () => (
  <section style={{ background: "#FFD23F", padding: "100px 56px", borderBottom: "2px solid #0E0E14",
    ...
    <div style={{ position: "relative", maxWidth: 1280, margin: "0 auto" }}>
      ...
      <h2 style={{
        ...
        margin: "14px 0 48px", maxWidth: 920, textWrap: "balance",
      }}>
        Pre-flight to arrivals hall, <span style={{ fontStyle: "italic", fontWeight: 500, color: "#2E5BFF" }}>in actual minutes.</span>
      </h2>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
        {[
          ...
          { time: "Boarding", action: "On the jet bridge, toggle the new line ON and your home line's data OFF (so it doesn't try to roam).", color: "#FAF6EE" },
          { time: "Landing", action: "Phone goes off airplane mode. The eSIM registers with the local carrier within ~30 seconds.", color: "#FAF6EE" },
          { time: "Arrivals hall", action: "You're online. Open Maps, book the taxi, send the \"landed\" text. Done.", color: "#7BE0B5", final: true },
        ].map((r, i) => (
          <div key={i} style={{
            ...
            padding: "20px 24px",
            marginBottom: 10,
            boxShadow: r.final ? "6px 6px 0 #0E0E14" : "3px 3px 0 #0E0E14",
          }}>
            <div style={{ fontFamily: "var(--nlo-font-display)", fontWeight: 800,
              fontSize: 22, letterSpacing: "-0.02em", color: r.final ? "#2E5BFF" : "#0E0E14" }}>
              {r.time}
            </div>
            <div style={{ fontFamily: "var(--nlo-font-display)", fontWeight: 600,
              fontSize: 19, letterSpacing: "-0.015em", lineHeight: 1.35 }}>
              {r.action}
            </div>
          </div>
        ))}
    ...
    <div style={{ maxWidth: 1280, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 40, flexWrap: "wrap", marginBottom: 40 }}>
        <div>
          ...
          <h2 style={{
            fontFamily: "var(--nlo-font-display)", fontWeight: 800,
            fontSize: 76, letterSpacing: "-0.04em", lineHeight: 0.9,
            margin: "14px 0 0", maxWidth: 880, textWrap: "balance",
          }}>
            Three quick fixes,<br/>
            then we take over.
          </h2>
        </div>
        <Btn color="ink" size="md" href="Support.html">Open WhatsApp →</Btn>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
        {[
          ...
          <div key={s.n} style={{
            background: "#fff", border: "3px solid #0E0E14", borderRadius: 24,
            boxShadow: "6px 6px 0 #0E0E14", padding: 28,
          }}>
            <div style={{
              width: 48, height: 48, borderRadius: 999,
              background: "#FFD23F", color: "#0E0E14", border: "2px solid #0E0E14",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontFamily: "var(--nlo-font-display)", fontWeight: 800, fontSize: 22,
            }}>{s.n}</div>
            <div style={{ fontFamily: "var(--nlo-font-display)", fontWeight: 800,
              fontSize: 24, letterSpacing: "-0.02em", lineHeight: 1.1, marginTop: 14 }}>{s.t}</div>
      ...
      <div style={{
        marginTop: 32, background: "#7BE0B5",
        border: "3px solid #0E0E14", borderRadius: 22,
        boxShadow: "6px 6px 0 #0E0E14", padding: "18px 24px",
        display: "flex", justifyContent: "space-between", alignItems: "center",
        gap: 20, flexWrap: "wrap",
      }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <span style={{ width: 12, height: 12, borderRadius: 999, background: "#0E0E14",
            boxShadow: "0 0 0 4px rgba(14,14,20,0.15)" }} />
          <span style={{ fontFamily: "var(--nlo-font-display)", fontWeight: 700, fontSize: 18, letterSpacing: "-0.015em" }}>
            Still stuck? A human on WhatsApp answers in &lt;2 minutes, 24/7.
          </span>
        </div>
        <Btn color="ink" size="md" href="Support.html">Chat now →</Btn>
      </div>
    </div>
  </section>
);
